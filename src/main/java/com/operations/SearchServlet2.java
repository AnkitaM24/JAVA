...
public class SearchServlet2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)   
        ...
        List<GetSet> list=Operations.search(search,col);
		...
		out.print("<div class=\"container p-2\">\r\n"
				...
				+ "				<div class=\"card-header text-center\"><h5>Search Record by</h5></div>\r\n"
				+ "  					<div class=\"card-body\">"
				+ "<table class=\"table\">\r\n"
				+ "  <thead>\r\n"
				+ "    <tr class=\"table-dark\">\r\n"
    ...
    out.print("<p class=\"text-center\">Record Searched.....</p></div></div></div></div>");
